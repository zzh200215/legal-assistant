...
def create_checkout(
    ...
    from app.services.observability.oplog_service import oplog_service  # noqa: E402
...
async def payment_webhook(
    ...
    """
    from app.services.billing.payment_event_service import WebhookRejectedError, payment_event_service
