...
async def build_consultation_card(question: str, user_id: int, db) -> dict:
    ...
    from app.services.legal.legal_service import consultation_payload, ensure_demo_sources
...
def _extract_file_text(file_bytes: bytes, file_name: str) -> str:
    ...
    from app.services.documents.document_parsing import extract_file_text as _extract
...
async def answer_file_review(open_id: str, file_key: str, file_name: str, db) -> dict:
    ...
    from app.services.legal.legal_service import review_contract
...
def parse_draft_fields(message: str, document_type: str) -> dict:
    ...
    from app.services.legal.legal_service import DRAFT_FIELDS
