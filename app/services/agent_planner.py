...
- 计划为结构化对象（见 app.services.agent_run_state.AgentPlan），包含步骤、工具、
  输入摘要、预期副作用与是否需要审批。
...
from app.services.agent_registry import AGENT_REGISTRY_VERSION, TASK_PROTOCOL_VERSION
from app.services.agent_run_state import AgentPlan, AgentPlanStep
